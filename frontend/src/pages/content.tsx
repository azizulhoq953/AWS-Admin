...
import { boardI18nStrings } from '../i18n/i18n-strings';
...
// Debounce handleLayoutChange function
const handleLayoutChangeDebounced = debounce((layout: ReadonlyArray<StoredWidgetPlacement>) => {
  itemsChanged.current = true;
  setLayout(layout);
}, 200);
      ...
      <div ref={ref}>
        <Board
          ...
          onItemsChange={({ detail: { items } }) => {
            handleLayoutChangeDebounced(exportLayout(items));
          }}
